...
//    }
    ...
    public Book(Author author, Genre genre, Publisher publisher, String name, byte[] content, int pageCount, String isbn, int publishYear, byte[] image, String descr, String bookcol) {
        this.author = author;
        this.genre = genre;
        this.publisher = publisher;
        this.name = name;
